class FavoritesController < ApplicationController
		...
		def index
			...
			@user = 
			@favorited_posts = Favorite.where(user_id: current_user.id, status: "favorited")
		...
		def create 
			...
			@favorite = Favorite.new(status: "favorited",
										user_id: current_user.id,
			...
			# else
			# 	@favorite = Favorite.update(status: "favorited")
